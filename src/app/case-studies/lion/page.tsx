                        ...
                        <div className="prose prose-lg max-w-none">
                            <p className="text-lg text-zinc-600 leading-relaxed mb-6">
                                <a href="https://lionhomeservice.com/" target="_blank" className="text-blue font-semibold underline">
                                    Lion Home Service
                                </a> is Northern Colorado's premiere HVAC, plumbing, sewer, and electrical company. Based out of Fort Collins, their technicians serve the Interstate 25 corridor all the way up through southern Wyoming.
                            </p>
                            ...
                            <blockquote className="border-l-4 border-blue pl-6 py-4 my-8 bg-zinc-50">
                                <p className="text-lg italic text-zinc-700 font-serif">
                                    "Probook has made our dispatching more efficient, allowing us to handle more calls without increasing staff. The results speak for themselves."
                                </p>
                            ...
                            <blockquote className="border-l-4 border-blue pl-6 py-4 my-8 bg-zinc-50">
                                <p className="text-lg italic text-zinc-700 font-serif">
                                    "Probook has halved the amount of work we do daily."
                                </p>
                                <p className="text-base text-zinc-600 mt-2">
                            ...
                            <blockquote className="border-l-4 border-blue pl-6 py-4 my-8 bg-zinc-50">
                                <p className="text-lg italic text-zinc-700 font-serif">
                                    "All the dispatchers are trusting Probook. They quickly learned how to make it work, and it's been driving our dispatching decisions since our first day with them."
                                </p>
                                <p className="text-base text-zinc-600 mt-2">
                                    — General Manager, Bart Palmer
                                </p>
