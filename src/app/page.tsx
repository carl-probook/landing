            ...
            <main>
                <section className="pt-12 sm:pt-28 h-screen text-left relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
                        ...
                        <p className="text-base lg:text-lg text-black mb-8 max-w-3xl">
                ...
                <section className="border-t border-light-grey py-12 relative">
                    <div className="absolute font-serif text-base lg:text-lg border border-light-grey flex items-center justify-center px-6 py-3 width-fit height-fit left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 bg-white font-semibold text-black">
                        Official Partners
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-8">
                        ...
                        <div className="flex flex-col lg:flex-row gap-8">
                            <Link href="/case-studies/auchinachie" className="w-full bg-white border border-light-grey p-6 flex flex-col justify-between gap-6 transition-shadow duration-200 hover:shadow-lg cursor-pointer">
                                <p className="text-base lg:text-lg text-black font-normal leading-normal tracking-normal">
